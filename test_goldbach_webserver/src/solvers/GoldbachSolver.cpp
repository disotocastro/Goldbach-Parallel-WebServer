...
goldbach_solver::goldbach_solver(int64_t* inputNumbers, int64_t inputNumbersCount){
  numbers = readNumbers(inputNumbers,inputNumbersCount);
  prime_numbers(numbers);
  goldbach(numbers);
}

goldbach_solver::~goldbach_solver(){
  free_memory(numbers);
}

void goldbach_solver::goldbach(NumbersArray_t* NumbersArray) {
...
void goldbach_solver::prime_numbers(NumbersArray_t* NumbersArray) {
...
bool goldbach_solver::is_prime(int64_t number) {
  bool prime = true;
...
void goldbach_solver::goldbach_pair(NumbersArray_t* NumbersArray, int64_t index) {
  int64_t newSize = 0;
...
void goldbach_solver::goldbach_odd(NumbersArray_t* NumbersArray, int64_t index) {
  int64_t newSize = 0;
  int64_t number = NumbersArray->GoldbachSumsArray[index]->number;
  int64_t goldbachSumsCounter = 0;
